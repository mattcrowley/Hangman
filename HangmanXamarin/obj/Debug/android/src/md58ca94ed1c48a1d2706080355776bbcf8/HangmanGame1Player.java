...
public class HangmanGame1Player
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HangmanXamarin.HangmanGame1Player, HangmanXamarin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", HangmanGame1Player.class, __md_methods);
	}


	public HangmanGame1Player ()
	{
		super ();
		if (getClass () == HangmanGame1Player.class)
			mono.android.TypeManager.Activate ("HangmanXamarin.HangmanGame1Player, HangmanXamarin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
